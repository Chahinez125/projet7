...
function displayFilteredRecipes() {
 ...
 // Ajout d'un écouteur d'événement sur chaque champ de recherche
 [searchIngredientTag, searchDeviceTag, searchUstensilTag].forEach((input) => {
   input.addEventListener("input", () => {
     // Filtre les recettes selon les critères de recherche
 ...
 function filterIngredients() {
  ...
  for (let i = 0; i < allIngredients.length; i++) {
    ...
    if (ingredient.innerHTML.toLowerCase().includes(ingredientTagValue)) {
